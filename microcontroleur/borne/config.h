...
// =============================================
#define WIFI_SSID       "iPhone de Semih"
#define WIFI_PASSWORD   "semih1453"
#define SERVER_IP       "172.20.10.8"   // IP de la machine qui fait tourner le serveur Java
...
#define DEFAULT_DELAI_FERMETURE_MS  10000   // B : temps max pour fermer avant buzzer
